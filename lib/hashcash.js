(function() {
  ...
  define(["./copyright", "./sha1", "./taskmaster"], function(cc, sha1, taskmaster) {
    var HashCash, NodeTaskMaster, TimeoutTaskMaster, WebTaskMaster, _buildDate, _nextPos;
    NodeTaskMaster = taskmaster.NodeTaskMaster, WebTaskMaster = taskmaster.WebTaskMaster, TimeoutTaskMaster = taskmaster.TimeoutTaskMaster;
